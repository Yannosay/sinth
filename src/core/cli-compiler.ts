...
import { eventAttrName, INLINE_STYLE_PROPS, resolveBuiltinTag, registerExpr, renderAttr, renderChild, renderIfBlock, renderCompUse, expandUserComp, collectScripts, extractFunctionNames, buildRuntime } from "./compiler.ts";
